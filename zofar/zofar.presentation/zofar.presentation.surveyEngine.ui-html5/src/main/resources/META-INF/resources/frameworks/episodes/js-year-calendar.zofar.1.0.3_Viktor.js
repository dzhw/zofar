    ...
    {   key: "_zofarResponsiveRenderBody",
		...
		for(var y = startY; y <= stopY;y++){
	            ...
	            for (var m = 1; m <= 12; m++) {
	                ...
	                */
	            	 var seasonTdSlot = document.createElement('td');
		                seasonTdSlot.classList.add('seasonSlotLarge');
                        ...
                        var monthBodyCellOverview = document.createElement('td');
                        monthBodyCellOverview.classList.add('zofar-structure-table-body-cell');
                        monthBodyCellOverview.classList.add('month-overview');
                        
                        var slotOverviewButton = document.createElement("div");
      	              	slotOverviewButton.setAttribute("class", "divOverview");
      	              	$(slotOverviewButton).text('+');
                        
//                        monthBodyCellOverview.appendChild(slotOverviewButton);
                        
//                        monthBodyCellOverview.classList.add('month');
//                        monthBodyCellOverview.classList.add('zofar-month');
//                        monthBodyCellOverview.classList.add('zofar-month-'.concat(m.toString()));
                        
                        
                        seasonTdSlot.appendChild(monthBodyCell);
                        seasonTdSlot.appendChild(slotOverviewButton);
                        yearRow.appendChild(seasonTdSlot);
//                        seasonTd.appendChild(seasonTdSlot);
...
//                        yearRow.appendChild(monthBodyCell);
	...
	/*				    TODO: Reihenfolge Monate*/
					    ...
					    var seasonTdSlot = document.createElement('td');
		                seasonTdSlot.classList.add('seasonSlot');
...
//                           seasonTdSlot.appendChild(monthBodyCellOverview);
                           seasonTd.appendChild(seasonTdSlot);
//                           
//                           seasonTd.appendChild(monthBodyCell);
//                           console.log("CHECK "+monthId);  
        	            }
      ...
      }, 
      {
        ...
        }, 
        {
            ...
            value: function _zofarResponsiveRenderDataSourceMonth(month,events,slotCount,slotLimit) {
              ...
              var slotDivParent = document.createElement("div");
              slotDivParent.setAttribute("class", "slotDivParent");
              
              var filledSlotCounter= 0 ;
              for (var slot = 0; slot < Math.min(slotCount,slotLimit);slot++) {
	              ...
	              slotDivParent.appendChild(slotDiv);
              }
              
//              TODO VD Button Overview 
//              if (filledSlotCounter>0) {
//            	  if (slotCount>=4 && (hasFocus && !focusEpisodes.includes(event.id))) {
            	  
//	              var slotOverviewButton = document.createElement("input");
//	              slotOverviewButton.setAttribute("type", "button"); 
//	              slotOverviewButton.setAttribute("value", "+");
//	              slotOverviewButton.setAttribute("class", "btn btn-secondary zo-buttonOverview");
//	              slotDivParent.appendChild(slotOverviewButton);
	              
//              }
              month.appendChild(slotDivParent);
              
              
//              var slotSpan = document.createElement("span");
//              slotSpan.setAttribute("class", "month_spanOverview");
//              $(slotSpan).text("AHA");
//              month.appendChild(slotSpan);
