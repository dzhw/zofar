...
public class SystemConfiguration implements Serializable {
	...
	public Boolean record(){
		if((properties != null)&&(properties.containsKey("record"))) {
			return Boolean.parseBoolean((String)properties.get("record"));
		}
		return false;
	}
	public String recordDir(){
		if((properties != null)&&(properties.containsKey("recorddir"))) {
			return (String)properties.get("recorddir");
		}
	...
	public Boolean episodes(){
		if((properties != null)&&(properties.containsKey("episodes")))return Boolean.parseBoolean((String)properties.get("episodes"));
		return false;
	}
}
